...
def test_change_speed_doubles_playback_speed():
    expected_output = np.genfromtxt('data/change_speed/bark_double_speed.csv', dtype = 'float32')
...
def test_change_speed_halves_playback_speed():
    expected_output = np.genfromtxt('data/change_speed/bark_half_speed.csv', dtype = 'float32')
